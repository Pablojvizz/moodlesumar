...
//20140707   - A pedido de Natalia  - Ticket  #667351 - danielbzn
// Cuando el tipo de documento es 'documento unico' tiene que imprimirse 'DNI' en el certificado
$tipo = "";
if( $dnitipo->data == 'Documento Único'){
    $tipo = "DNI";
}
else {
    $tipo = $dnitipo->data;
}
certificate_print_text($pdf, $x, $y + 40, 'C', 'FreeSerif', 'IB', 25, fullname($USER) . ' ,  '.$tipo.' '.$dninro->data);
