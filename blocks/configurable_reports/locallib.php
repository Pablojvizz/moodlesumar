...
//fin
    ...
    //UVQ-UNQ Inicio Pablo
    $querysql2 = optional_param('querysql2','',PARAM_INT);
    if ($querysql2==1){
    $output .= '<table  align="center" width="'.$table->width.'"><tr><td align="right"><a href="/blocks/configurable_reports/viewreport.php?id='.$id.'"><img src="http://plannacertest.uvq.edu.ar/theme/image.php?theme=boxxie2&image=i%2Freturn&rev=260" /> P&aacute;gina Anterior</a></td></tr></table>';
    }
    // fin UVQ-UNQ
...
//UVQ-UNQ Inicio Pablo
                    ...
                    if ($itemexplode[0]=="BRA"){
                        //echo $itemexplode[1];

                        $item='<center><a href="./viewreport.php?id='.$id.'&querysql2=1&we='.$itemexplode[1].'"><img alt="Información de respaldo" src="http://plannacertest.uvq.edu.ar/theme/image.php?theme=boxxie2&image=i%2Fusers&rev=260" /></a></center>';
                        //$item=str_replace('"',chr(148) , $item);
                        //echo $item;
                        //die;
                        }
//Fin                    
