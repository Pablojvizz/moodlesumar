...
class customsql_form extends moodleform {
 function definition() {
        ...
        $mform->addElement('textarea', 'querysql2', get_string('querysql', 'block_configurable_reports'),
                'rows="25" cols="60"');
        $mform->addRule('querysql2', get_string('required'),
                '', null, 'client');
        $mform->setType('querysql2', PARAM_RAW);
