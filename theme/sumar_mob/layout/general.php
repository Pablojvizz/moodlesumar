...
// get blocks?
$toblock = optional_param('sumar_mob_blocks', false, PARAM_BOOL);
// get settings?
$toset = optional_param('sumar_mob_settings', false, PARAM_BOOL);
...
$urlblocks = new moodle_url($PAGE->url, array('sumar_mob_blocks' => 'true'));
$urlsettings = new moodle_url($PAGE->url, array('sumar_mob_settings' => 'true'));
...
if ($gowide) {
    ...
    sumar_mob_initialise_colpos($PAGE);
}
$usercol = (sumar_mob_get_colpos() == 'on');

$renderer = $PAGE->get_renderer('theme_sumar_mob');
...
<body id="<?php p($PAGE->bodyid) ?>" class="<?php p($PAGE->bodyclasses.' '.join(' ', $bodyclasses)) ?>">
    ...
    <div id="<?php p($PAGE->bodyid) ?>PAGE" data-role="page" class="generalpage <?php echo 'ajaxedclass '; p($PAGE->bodyclasses.' '.join(' ', $bodyclasses));  ?> <?php if ($hasmyblocks && $usercol) { echo 'has-myblocks'; } ?> " data-title="<?php p($SITE->shortname) ?>">
        <!-- start header -->
        <div data-role="header" <?php echo($datatheme);?> class="sumar_mobheader">
        ...
        <!-- main content -->
        <div data-role="content" class="sumar_mobcontent" <?php echo $databodytheme; ?>>
          ...
          <?php } ?>
            ...
            <div class="content-secondary">
                ...
                <div data-role="fieldcontain" id="sliderdiv">
                    <label for="slider"><?php p(get_string('mtoggle','theme_sumar_mob')); ?>:</label>
        ...
        <div id="underfooter">
            ...
            <div class="credits">
              <a target="_blank" href="http://www.e-abclearning.com">
              <img border="0" src="/theme/sumar_mob/pix/logo_eabc.png">          </a>&nbsp;
              <a target="_blank" href="http://moodle.org">
              <img border="0" src="/theme/sumar_mob/pix/logo_moodle.png">          </a>&nbsp;&nbsp;
            </div>
