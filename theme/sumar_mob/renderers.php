...
/**
 * Renderers for the sumar_mob theme
 *
 * @package    theme
...
/**
 * A custom renderer for the sumar_mob theme to produce snippets of content.
 *
 * @package    theme
 * @subpackage sumar_mob
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_sumar_mob_renderer extends plugin_renderer_base {
...
/**
 * Overridden core renderer for the sumar_mob theme
 *
 * @package    theme
 * @subpackage sumar_mob
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_sumar_mob_core_renderer extends core_renderer {
    ...
    public function block(block_contents $bc, $region) {
        ...
        $bc = clone($bc);
        // The sumar_mob theme does not support collapsible blocks.
    ...
    protected function init_block_hider_js(block_contents $bc) {
        // The sumar_mob theme in no shape or form supports the hiding of blocks
        // this function has been defined and left empty intentionally so that
        // the block hider JS is not even included.
    }

    /**
     * Produces the navigation bar for the sumar_mob theme
     *
     * @return string
     */
    ...
    protected function render_help_icon(help_icon $helpicon) {
        ...
        $url = new moodle_url('/help.php', array('component' => $helpicon->component, 'identifier' => $helpicon->identifier, 'lang'=>current_language(), 'theme'=>'sumar_mob'));
...
/**
 * Overridden choie module renderer for the sumar_mob theme
 *
 * @package    theme
 * @subpackage sumar_mob
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_sumar_mob_mod_choice_renderer extends plugin_renderer_base {
