...
class flexible_table {
    ...
    function download_buttons() {
        if ($this->is_downloadable() && !$this->is_downloading()) {
            ...
            /*
            global $USER;
            if ($USER->username == 'eabc'){
                echo '<pre>';
                //var_dump($downloadelements);
                echo '</pre>';
            ...
            */
            ...
            if(strpos( $_SERVER['REQUEST_URI'] , '/mod/quiz/report.php?id') !== false){
                $html .= html_writer::tag('label', get_string('downloadas', 'table'));
                $html .= $downloadelements->formatsmenu. " ". $downloadelements->downloadbutton;
            }
            else{
